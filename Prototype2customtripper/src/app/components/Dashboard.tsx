...
import { authHeaders, getUsername } from "../lib/auth";
  ...
  useEffect(() => {
    ...
    const fetchBookings = async () => {
      try {
        ...
        setTrips([...savedTrips, ...serverTrips]);
      } catch (error: any) {
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {isLoading ? (
          <Card className="p-12 text-center">
            <div className="text-lg font-semibold text-gray-900 mb-2">Loading trips…</div>
            <p className="text-gray-600">This may take a moment while we fetch your data.</p>
          </Card>
        ) : loadError ? (
          <Card className="p-12 text-center">
            <div className="text-lg font-semibold text-gray-900 mb-2">Unable to load trips</div>
